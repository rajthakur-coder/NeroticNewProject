...
const AddProductForm: React.FC<AddProductFormProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      ...
      {/* Icon Upload */}
      <div>
        <label htmlFor="icon_file" className="block mb-2 text-sm font-medium text-gray-900">
          Icon
        </label>
        <div className="p-0">
        ...
        {values.icon && (
          <div className="mt-3">
            <img
              src={typeof values.icon === "string" ? values.icon : URL.createObjectURL(values.icon)}
              alt="preview"
