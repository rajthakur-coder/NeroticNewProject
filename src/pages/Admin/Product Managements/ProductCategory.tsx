...
const ProductCategory = () => {
    ...
    const actions = [
        { label: "Edit", icon: <EditIcon />, onClick: (category: Category) => handleEdit(category) },
        {
            label: "Delete",
            icon: <DeleteIcon />,
        ...
        <div className="rounded-lg bg-surface-body text-text-main">
            <div className="shadow-xl bg-surface-card rounded-xl">
                ...
                <div className="relative w-full mt-4">
                    {/* Selected Row Overlay (FIXED: Using Checkbox component) */}
                    <AnimatePresence>
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="p-3 w-12 min-w-[48px] pl-6">
                                                {/* Row Checkbox using new Checkbox component */}
                                                <Checkbox
                                                    checked={isChecked}
